  ...
  return (
    <div className='p-4'>
     ...
     justify-center rounded-full overflow-hidden drop-shadow-sm'>
      ...
      <button onClick={() => setUserProfileAvatarEdit(true)} className=' text-sm min-w-20 border border-primary-100 hover:border-r-primary-200 hover:bg-primary-200 px-3 py-1 rounded-full mt-3'>
        Chỉnh sửa
      </button>
      ...
      <form className='my-4 grid gap-4' onSubmit={handleSubmit}>
        ...
        hover:bg-primary-200 border-primary-100 text-primary-200
