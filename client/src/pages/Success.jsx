  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className={`relative bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full text-center border border-white/20 transition-all duration-1000 transform ${
        ...
        <div className={`bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 mb-8 border border-emerald-100 transition-all duration-1000 delay-700 transform ${
          animateElements ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
        }`}>
        ...
        {/* Footer Note */}
        <div className={`mt-8 text-xs text-gray-400 transition-all duration-1000 delay-1100 transform ${
          animateElements ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
        }`}>
