...
const UserMenu = ({ close }) => {
    ...
    // hàm này sẽ được gọi khi người dùng nhấn nút "Log Out"
    ...
    return (
        <div>
            ...
            <div className='text-sm items-center gap-2 flex'>
                <span className='max-w-52 text-ellipsis line-clamp-1'>{user.name || user.mobile}<span className='text-medium text-red-600'>{user.role ==="ADMIN" ? "(Quản trị viên)" : ""}</span></span>
            ...
            <div className='text-sm grid gap-1'>
...

                {
                    isAdmin(user.role) && (
                        ...
                        <Link onClick={handleClose} to={"/dashboard/upload-product"} className='px-2 hover:bg-orange-200 py-1'>Tải lên sản phẩm</Link>
