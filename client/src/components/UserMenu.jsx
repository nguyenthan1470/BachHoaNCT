        ...
        {!isAdmin(user.role) && (
          <>
            ...
            <Link
              onClick={handleClose}
              to="/dashboard/profile"
              className={`flex items-center gap-2 px-3 py-2 rounded transition text-gray-700 ${isActive('/profile') ? 'bg-green-100 border-l-4 border-green-600' : 'hover:bg-green-100'}`}
              aria-label="Hồ sơ "
