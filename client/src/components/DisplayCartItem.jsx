                        ...
                        cartItem[0] ? (
                            <>
                                <div className='flex items-center justify-between px-4 py-2 bg-blue-100 text-blue-500 rounded-full'>
                                    ...
                                    <p>{DisplayPriceInVietnamDong(notDiscountTotalPrice - totalPrice)}</p>
                                </div>
                                                ...
                                                return (
                                                    <div key={item?._id + "cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='font-semibold'>{DisplayPriceInVietnamDong(pricewithDiscount(item?.productId?.price, item?.productId?.discount))}</p>
                                                        </div>
                                                        <div>
                                ...
                                <div className='bg-white p-4'>
                                    ...
                                    <div className='flex gap-4 justify-between ml-1'>
                                        <p>Tổng số tiền</p>
                                        <p className='flex items-center gap-2'><span className='line-through text-neutral-400'>{DisplayPriceInVietnamDong(notDiscountTotalPrice)}</span>
                                            <span>{DisplayPriceInVietnamDong(totalPrice)}</span></p>
                                    </div>
                                    <div className='flex gap-4 justify-between ml-1'>
                                        <p>Tổng số lượng</p>
                            ...
                            <div className='bg-white flex flex-col justify-center items-center'>
                                ...
                                />
                                <Link onClick={close} to={"/"} className='block bg-green-600 px-4 py-2 text-white rounded'>Mua sắm ngay bây giờ</Link>
                            </div>
                        )
                    }
                    ...
                    cartItem[0] && (
                        <div className='p-2'>
                            <div className='bg-green-700 text-neutral-100 px-4 font-bold text-base py-4 static bottom-3 rounded flex items-center gap-4 justify-between'>
                                <div>
                                    {DisplayPriceInVietnamDong(totalPrice)}
                                </div>
